# Zwibba — règles de raffinement de l’interface
Date : 21 septembre 2026. Direction approuvée : Clean pour les parcours, Friendly pour le contenu ; identité existante conservée.

- Garder le logo, le vert, les surfaces sombres et la police Sora déjà distribués. Utiliser les tokens de src/site/styles.css.
- Vitrine : voir les annonces ou vendre, puis les objets réels avant les explications. App : accomplir une tâche avec priorité au contact.
