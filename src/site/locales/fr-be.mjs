// TRADUCTION GÉNÉRÉE — relecture par un locuteur natif requise avant lancement public.
...
export const site = {
  ...
  locale: 'fr_BE',
  description:
    "Zwibba est la place de marché pensée pour le mobile en Belgique. Prenez une photo, laissez l'IA préparer votre annonce, puis publiez en quelques secondes.",
  marketLabel: 'Belgique',
  phonePrefix: '+32',
  htmlLang: 'fr',
  ogLocale: 'fr_BE',
  market: 'BE',
  ...
  socialProof: [
    ...
    { value: '16', label: 'catégories clés pour la Belgique' },
    { value: '100 % mobile', label: 'une expérience pensée pour le téléphone' },
  ],
};
...
export const ui = {
  ...
  landing: {
    ...
    heroStage: {
      ...
      aiCopy: "L'application prend vos photos, trouve la catégorie et propose une description et un prix en euros.",
      ...
      lightLabel: 'Léger et rapide',
      lightCopy: 'Peu de chargement et des images légères pour garder une navigation fluide, même en déplacement.',
    },
    flow: {
    ...
    categories: {
      eyebrow: 'Catégories',
      title: 'Des univers clés pour le marché belge.',
      copy: 'Téléphones, immobilier, services, alimentation ou emploi : les catégories suivent les usages du terrain.',
    },
    why: {
  ...
  about: {
    ...
    pageDescription:
      'Découvrez la vision de Zwibba, une place de marché pensée pour la Belgique et pour les usages réels du marché local.',
    hero: {
      eyebrow: 'À propos',
      title: 'Zwibba construit un marché local, mobile et utile dès le premier usage.',
      copy: 'Le produit est pensé pour la Belgique. Il aide à vendre vite, reste simple à comprendre et fonctionne bien partout.',
    },
    values: {
    ...
    context: {
      eyebrow: 'Contexte',
      title: "La Belgique d'abord, l'Europe ensuite.",
      copy: 'Prix en euros, catégories claires, commune comme filtre et partage WhatsApp par défaut : le site montre le vrai contexte local.',
      notes: [
        {
          title: 'IA utile',
  ...
  browse: {
    ...
    filters: {
      ...
      searchPlaceholder: 'Ex: Galaxy, appartement, plomberie...',
      ...
      priceOptions: [
        ...
        { value: '1001-999999999', label: '1 001 € ou plus' },
      ],
      sortLabel: 'Tri',
      sortOptions: [
...
export const featureSteps = [
  ...
  },
  {
    ...
    copy: 'Titre, catégorie, état, description et prix en euros sont proposés automatiquement.',
  },
  {
    step: '03',
...
export const platformHighlights = [
  {
    title: 'Conçu pour la Belgique',
    copy: 'Filtres par commune, prix en euros et catégories utiles pour le marché local.',
  },
  {
    title: 'Paiement simple et local',
    copy: 'Bancontact et Payconiq servent pour les options payantes et la mise en avant.',
  },
  {
    title: 'Accès protégé',
  ...
  },
  {
    ...
    copy: 'Des images légères et peu de chargement pour ouvrir vite, même en déplacement.',
  },
];
...
export const testimonials = [
  {
    ...
    name: 'Sophie V.',
    role: 'Vendeuse occasionnelle, Namur',
  },
  {
    quote:
  ...
  },
  {
    ...
    name: 'Karim B.',
    role: 'Acheteur, Bruxelles',
  },
];

export const faqs = [
  {
    question: 'Est-ce que Zwibba est déjà disponible partout en Belgique ?',
    answer: 'Le lancement commence dans quelques villes, avec une extension progressive à toute la Belgique.',
  },
  {
...
export const aboutValues = [
  {
    ...
    copy: "Chaque écran doit faire gagner du temps. Si votre grand-mère ne peut pas publier en moins d'une minute, on recommence.",
  },
  {
...
export const supportTopics = [
  ...
  },
  {
    ...
    copy: 'Suggestions sur le parcours, la confiance, les catégories ou les performances de la plateforme.',
