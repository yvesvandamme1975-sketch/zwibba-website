export const site = {
  ...
  socialProof: [
    ...
    { value: '13', label: 'catégories clés pour Lubumbashi' },
...
export const categories = [
  ...
  { slug: 'construction', label: 'Construction', icon: 'Route', hint: 'Matériaux, outils, quincaillerie, équipements de chantier.' },
  ...
  { slug: 'fashion', label: 'Mode', icon: 'Etoile', hint: 'Vêtements, bijoux, chaussures, cosmétiques.' },
